...
<section>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="listing-shot-caption">
					...
					<a href="#" class="author-img-box"><img src="assets/img/user-1.png" class="img-responsive author"
							alt="" /></a>
				</div>
				</a>
		...
		<div class="col-md-4 col-sm-6">
			...
			<div class="listing-shot-caption">
				<h4>Education</h4>
				<p class="listing-location">Bishop Avenue, New York</p>
				<a href="#" class="author-img-box"><img src="assets/img/user-2.jpg" class="img-responsive author"
						alt="" /></a>
			</div>
			</a>
			<div class="listing-shot-info">
	...
	<div class="col-md-4 col-sm-6">
		...
		<div class="listing-shot-caption">
			<h4>Documentary</h4>
			<p class="listing-location">Bishop Avenue, New York</p>
			<a href="#" class="author-img-box"><img src="assets/img/user-3.jpg" class="img-responsive author"
					alt="" /></a>
		</div>
		</a>
		<div class="listing-shot-info">
