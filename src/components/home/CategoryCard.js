...
const CategoryCard = () => {
  return (
    ...
    <div class="rounded-lg overflow-hidden">
        <a href="event-listing-details-page.html" class="relative overflow-hidden group">
            ...
            <img class="w-full h-80 object-cover group-hover:scale-105 transition-all"
                src="assets/img/Image/landing-page-image/researching.jpg" alt="" />
            <div
                class="absolute bottom-0 top-1/2 flex items-start flex-col justify-end left-0 pb-5 pl-5 pt-2 card-linear-gradient w-full">
                <span class="bg-warning-600 text-xs text-white rounded-full px-3 py-1 mb-3 inline-flex">
                    Coaching
                </span>
        ...
        <div class="flex justify-between flex-wrap relative z-[1] p-6 bg-gray-100 dark:bg-foreground">
            <div class="flex items-center">
                <div class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor"
                        class="w-5 h-5 flex-shrink-0 text-yellow-400">
                        <path
                ...
                <span class="text-base mx-2 dark:text-gray-100 font-medium">
                    4.5
                </span>
            ...
            <div class="flex">
                <button type="button"
                    ...
                    <svg class="w-6 h-6 flex-shrink-0" width="20" height="20" viewbox="0 0 20 20"
